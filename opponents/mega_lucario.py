...
def agent(obs_dict: dict) -> list[int]:
    ...
    if context == SelectContext.MAIN:
        ...
        for o in select.option:
            ...
            elif o.type == OptionType.RETREAT: can_switch = True
            elif o.type == OptionType.ATTACK:
                can_attack = True
                if o.attackId == 983: can_use_mega_brave = True
        ...
        if state.turn >= 2:
            ...
            for i, my_pokemon in enumerate(my_cards):
                ...
                for a in range(2):
                    ...
                    if a == 1 and i == 0 and energy_count >= 2 and not can_use_mega_brave: break
                    ...
                    for j, op_pokemon in enumerate(op_cards):
                        ...
                        if op_pokemon.hp <= damage: prize = prize_count(op_pokemon)
                        else: score *= damage / op_pokemon.hp
                        score += base_score
        ...
        if o.type == OptionType.NUMBER:
            ...
            if data.cardType == CardType.POKEMON:
                ...
                if card.id == Switch:
                    ...
                    score = -1 if stadium_id == 0 else 10000
