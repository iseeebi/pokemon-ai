...
print(f"Tar output : submissions/v{next_v}_dragapult_ex.tar.gz")
...
tar_path = os.path.join(submissions_dir, f"v{next_v}_dragapult_ex.tar.gz")
...
print(f"  [3] Created -> submissions/v{next_v}_dragapult_ex.tar.gz")
